...
namespace CRMRetail.Datos
{
    internal sealed class AccesoDatos
    {
        ...
        {
            dbconnection = new SqlConnection(ConfigurationManager.ConnectionStrings["CRMRetailConnectionDBContext"].ConnectionString);
            dbconnection.Open();
        }
        ...
        /// <summary>
        /// Agrega un parámetro con un valor nulo
        /// </summary>
        ...
        internal void AddParameterDecimal(string name, object value, byte precision, byte scale)
        {
            SqlParameter param = new SqlParameter()
            {
                ParameterName = name,
        ...
        /// (se usa en conjunto con InserUpdateDeletetWithReturnValue)
        /// </summary>
        ...
        /// <summary>
        /// Ejecuta una consulta de inserción con un valor de retorno 
        /// (para usarse en conjunto con AddParameterWithReturnValue)
        /// </summary>				
        internal int InserUpdateDeletetWithReturnValue()
        {
            int recibido = 0;
            try
            {                
